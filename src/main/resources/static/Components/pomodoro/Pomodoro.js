...
let customminutes = 0;
let customseconds = 0;
let custompercento = 100 / ((customhours * 3600) + (customminutes * 60) + customseconds); // this is % of gauge

// For custom Break
let custombreakhours = 0;
let custombreakminutes = 0;
let custombreakseconds = 0;
let custombreakpercento = 100 / ((custombreakhours * 3600) + (custombreakminutes * 60) + custombreakseconds); // this is % of gauge
// For fixed for break default
let breakfixhours = 0;
let breakfixmin = 5;
let breakfixsec = 0;
let breakpercento = 100 / ((breakfixhours * 3600) + (breakfixmin * 60) + breakfixsec); // this is % of gauge
...
saveButton.addEventListener("click", () => {
    ...
    const minuteFocus = parseInt(document.getElementById("minuteInput").value) || 0;
    const secondFocus = parseInt(document.getElementById("secondInput").value) || 0;
    const hourBreak = parseInt(document.getElementById("Breakhour").value) || 0;
    const minuteBreak = parseInt(document.getElementById("Breakminute").value) || 0;
    const secondBreak = parseInt(document.getElementById("Breaksecond").value) || 0;
    ...
    custombreakpercento = 100 / ((hourBreak * 3600) + (minuteBreak * 60) + secondBreak);
    hours = customhours;
    minutes = customminutes;
    seconds = customseconds;
    percento = custompercento;
    ...
    custompomodoro = true;
    custombreak = true;
    if ((hourFocus <= 0 && minuteFocus <= 0 && secondFocus <=0) || (hourBreak <= 0 && minuteBreak <= 0 && secondBreak <=0)) {
